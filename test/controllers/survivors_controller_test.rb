...
class SurvivorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create survivor" do
    assert_difference("Survivor.count") do
      post survivors_url, params: { survivor: { age: @survivor.age, gender: @survivor.gender, last_location: @survivor.last_location } }
    end
  ...
  test "should update survivor" do
    patch survivor_url(@survivor), params: { survivor: { age: @survivor.age, gender: @survivor.gender, last_location: @survivor.last_location } }
